...
electron-packager . --ignore="source|scripts|configs|node_modules" --overwrite --asar=true --platform=win32 --arch=x64 --icon=source/main/assets/icons/win/icon.ico --prune=true --out=bin --version-string.CompanyName=CE --version-string.FileDescription=CE --version-string.ProductName="AWS Glacier Console"
