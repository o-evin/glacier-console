...
export default new Map([
  [AwsRegion.US_EAST_OHIO, {name: 'US East (Ohio)'}],
  [AwsRegion.US_EAST_NVIRGINIA, {name: 'US East (N. Virginia)'}],
  [AwsRegion.US_WEST_NCALIFORNIA, {name: 'US West (N. California)'}],
  [AwsRegion.US_WEST_OREGON, {name: 'US West (Oregon)'}],
  ...
  [AwsRegion.EU_IRELAND, {name: 'EU (Ireland)'}],
  [AwsRegion.EU_LONDON, {name: 'EU (London)'}],
]);
